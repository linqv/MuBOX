    ...
    fun opensAndRendersSupportedDocumentFixtures() {
        ...
        fixtures.forEach { fixture ->
            ...
            try {
                ...
                val outputFile = File(outputDir, "${fixture.assetName}.page-0.png")
                handle.renderPageToPng(pageIndex = 0, outputFile = outputFile)

                assertTrue("${fixture.assetName} should render a PNG", outputFile.isFile)
