...
class LibraryDatabaseMigrationTest {
    ...
    @Test
    fun opensVersionOneLibraryDatabaseAfterFileDirectorySourceTableIsAdded() = runTest {
        createVersionOneLibraryDatabase()

        val database = createLibraryDatabase(context, TEST_DATABASE_NAME)
        try {
    ...
    @Test
    fun opensVersionTwoLibraryDatabaseAfterWebDavConnectionColumnsAreAdded() = runTest {
        createVersionTwoLibraryDatabase()
    ...
    private fun createVersionOneLibraryDatabase() {
        context.deleteDatabase(TEST_DATABASE_NAME)
    ...
    private fun createVersionTwoLibraryDatabase() {
        createVersionOneLibraryDatabase()
        context.openOrCreateDatabase(TEST_DATABASE_NAME, Context.MODE_PRIVATE, null).use { db ->
            db.execSQL(
                """
