...
internal fun com.example.comicdav.core.model.cache.ComicCacheCategory.cacheLabel(): String =
    when (this) {
        ...
        com.example.comicdav.core.model.cache.ComicCacheCategory.VIDEO_THUMBNAILS -> "视频缩略图缓存"
        com.example.comicdav.core.model.cache.ComicCacheCategory.HISTORY_THUMBNAILS -> "历史漫画封面缓存"
