...
import org.mubox.reader.ui.MuBoxBottomNavigation
import org.mubox.reader.ui.MuBoxGradientButton
import org.mubox.reader.ui.MuBoxNavDestination
...
internal fun muBoxRequestedOrientation(
...
internal fun ReaderOrientationEffects(
    ...
    val requestedOrientation = muBoxRequestedOrientation(
...
internal enum class AppTab {
    ...
    val label: String
        get() = when (this) {
            HOME -> MuBoxCopy.homeTab
            SOURCES -> MuBoxCopy.sourcesTab
            DOWNLOADS -> MuBoxCopy.downloadsTab
            SETTINGS -> MuBoxCopy.settingsTab
        }
...
internal fun DataFolderGateScreen(
    ...
    val colors = org.mubox.reader.ui.rememberMuBoxColors()
    Column(
        modifier = modifier
        ...
        Text(
            text = MuBoxCopy.chooseDataFolderTitle,
            style = MaterialTheme.typography.headlineSmall,
            color = colors.text,
            textAlign = androidx.compose.ui.text.style.TextAlign.Center,
        )
        Text(
            text = MuBoxCopy.chooseDataFolderBody,
            modifier = Modifier
                .fillMaxWidth()
...
internal fun org.mubox.reader.core.model.cache.ComicCacheCategory.cacheLabel(): String =
    when (this) {
        org.mubox.reader.core.model.cache.ComicCacheCategory.REMOTE_DOWNLOADS -> "远程整本缓存"
        org.mubox.reader.core.model.cache.ComicCacheCategory.REMOTE_INDEX -> "WebDAV 索引缓存"
        org.mubox.reader.core.model.cache.ComicCacheCategory.READER_PAGES -> "页面图片缓存"
        org.mubox.reader.core.model.cache.ComicCacheCategory.TRANSIENT_READER_PAGES -> "临时页面缓存"
        org.mubox.reader.core.model.cache.ComicCacheCategory.LIBRARY_COVERS -> "书架封面缓存"
        org.mubox.reader.core.model.cache.ComicCacheCategory.VIDEO_THUMBNAILS -> "视频缩略图缓存"
        org.mubox.reader.core.model.cache.ComicCacheCategory.HISTORY_THUMBNAILS -> "历史漫画封面缓存"
        org.mubox.reader.core.model.cache.ComicCacheCategory.VIDEO_SUBTITLES -> "视频字幕缓存"
        org.mubox.reader.core.model.cache.ComicCacheCategory.CODE_CACHE -> "运行时代码缓存"
