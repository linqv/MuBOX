...
// Sepia
private val MuBoxSepiaColors = lightColorScheme(
...
// Night
private val MuBoxNightColors = darkColorScheme(
...
// High Contrast
private val MuBoxHighContrastColors = lightColorScheme(
...
fun muBoxColorSchemeFor(palette: AppColorPalette, darkTheme: Boolean): ColorScheme =
    when (palette) {
        ...
        AppColorPalette.SEPIA -> MuBoxSepiaColors
        AppColorPalette.NIGHT -> MuBoxNightColors
        AppColorPalette.HIGH_CONTRAST -> MuBoxHighContrastColors
    }
...
fun MuBoxTheme(
    ...
    val colorScheme = muBoxColorSchemeFor(palette, darkTheme = isSystemInDarkTheme())
    MaterialTheme(
