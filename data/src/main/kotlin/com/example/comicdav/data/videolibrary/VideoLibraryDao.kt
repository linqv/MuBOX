...
@Dao
internal abstract class VideoLibraryDao {
    @Insert
    ...
    internal abstract fun observeVideoLibrary(): Flow<List<VideoLibraryItemRelation>>

    @Transaction
    @Query("SELECT * FROM video_library_items ORDER BY addedAt DESC, id DESC")
    internal abstract suspend fun getVideoLibrary(): List<VideoLibraryItemRelation>
