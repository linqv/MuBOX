...
import org.mubox.reader.ui.directorylisting.DirectoryListingTopBar
import org.mubox.reader.ui.directorylisting.DirectoryListingScrollStateRetention
...
import org.mubox.reader.ui.directorylisting.rememberDirectoryVideoArtworkModel
import org.mubox.reader.ui.directorylisting.shouldRequestDirectoryVideoThumbnail
import org.mubox.reader.ui.MuBoxCopy
import org.mubox.reader.ui.MuBoxDenseMediaRow
import org.mubox.reader.ui.MuBoxInlineMessage
import org.mubox.reader.ui.MU_BOX_MEDIA_GRID_COLUMN_COUNT
import org.mubox.reader.ui.MuBoxMediaGridTile
import org.mubox.reader.ui.MuBoxMetrics
import org.mubox.reader.ui.MuBoxSourceRow
import org.mubox.reader.ui.muBoxAppBackground
import org.mubox.reader.ui.muBoxGlassSurface
...
private fun FileDirectoryBrowseHeader(
    ...
    sortDirection: org.mubox.reader.ui.directorylisting.DirectorySortDirection,
    viewMode: DirectoryListingViewMode,
    onSearchQueryChange: (String) -> Unit,
    onSortFieldChange: (DirectorySortField) -> Unit,
    onToggleSortDirection: () -> Unit,
...
private fun LocalSourceSection(
    ...
    SourcePanel(
        ...
        actionLabel = MuBoxCopy.addLocalFolder,
...
internal fun fileDirectoryEntryTypeContentDescription(mediaKind: MediaKind): String =
    org.mubox.reader.ui.muBoxMediaKindLabel(mediaKind)
