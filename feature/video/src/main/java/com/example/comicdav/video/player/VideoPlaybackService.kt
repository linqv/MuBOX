...
class VideoPlaybackService : Service() {
    ...
    companion object {
        const val ACTION_PLAYBACK_STOPPED = "com.example.comicdav.video.action.PLAYBACK_STOPPED"
        private const val CHANNEL_ID = "video_background_playback"
        private const val NOTIFICATION_ID = 1001
        private const val ACTION_STOP = "stop"
        private const val EXTRA_DISPLAY_NAME = "com.example.comicdav.video.extra.DISPLAY_NAME"
        private const val EXTRA_PLAYBACK_SESSION_ID = "com.example.comicdav.video.extra.PLAYBACK_SESSION_ID"
