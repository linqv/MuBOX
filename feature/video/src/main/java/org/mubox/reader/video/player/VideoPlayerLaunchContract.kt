...
object VideoPlayerLaunchContract {
    const val EXTRA_SOURCE = "org.mubox.reader.video.extra.SOURCE"
    const val EXTRA_URI = "org.mubox.reader.video.extra.URI"
    const val EXTRA_DISPLAY_NAME = "org.mubox.reader.video.extra.DISPLAY_NAME"
    const val EXTRA_SIZE = "org.mubox.reader.video.extra.SIZE"
    const val EXTRA_LAST_MODIFIED = "org.mubox.reader.video.extra.LAST_MODIFIED"
    const val EXTRA_ACCOUNT_ID = "org.mubox.reader.video.extra.ACCOUNT_ID"
    const val EXTRA_ETAG = "org.mubox.reader.video.extra.ETAG"
    const val EXTRA_SUBTITLE_URIS = "org.mubox.reader.video.extra.SUBTITLE_URIS"
    const val EXTRA_SUBTITLE_NAMES = "org.mubox.reader.video.extra.SUBTITLE_NAMES"
    const val EXTRA_WEB_DAV_STREAM_IDS = "org.mubox.reader.video.extra.WEB_DAV_STREAM_IDS"
    const val EXTRA_PLAYBACK_KEY = "org.mubox.reader.video.extra.PLAYBACK_KEY"
    const val EXTRA_RESUME_ENABLED = "org.mubox.reader.video.extra.RESUME_ENABLED"
    const val EXTRA_REMOTE_PATH = "org.mubox.reader.video.extra.REMOTE_PATH"
    const val EXTRA_VIDEO_OUTPUT_MODE = "org.mubox.reader.video.extra.VIDEO_OUTPUT_MODE"
    const val EXTRA_GPU_API_MODE = "org.mubox.reader.video.extra.GPU_API_MODE"
    const val EXTRA_VIDEO_DECODER_MODE = "org.mubox.reader.video.extra.VIDEO_DECODER_MODE"
    const val EXTRA_MPV_PROFILE_MODE = "org.mubox.reader.video.extra.MPV_PROFILE_MODE"
    const val EXTRA_CONTROLS_AUTO_HIDE_MILLIS = "org.mubox.reader.video.extra.CONTROLS_AUTO_HIDE_MILLIS"
    const val EXTRA_PLAYER_ORIENTATION_MODE = "org.mubox.reader.video.extra.PLAYER_ORIENTATION_MODE"
    ...
    const val EXTRA_ANIME4K_QUALITY = "org.mubox.reader.video.extra.ANIME4K_QUALITY"
    const val EXTRA_PLAYER_OPTIONS = "org.mubox.reader.video.extra.PLAYER_OPTIONS"
    const val EXTRA_EPISODE_QUEUE = "org.mubox.reader.video.extra.EPISODE_QUEUE_ID"
